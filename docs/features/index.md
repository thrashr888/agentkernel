...
Key capabilities beyond basic sandbox management.

- [Secrets](secrets.md) — Vault storage, proxy injection, placeholder tokens, and file-based injection
- [Development Containers](devcontainers.md) — opt-in JSONC devcontainer configuration for sandboxes
- [Browser Automation](browser-automation.md) — Headless browser control inside sandboxes
